...
class Graph():
    ...
    def __init__(self,
        ...
        self.num_node = 30
        edge = np.ones((self.num_node, self.num_node))
        normalize_adjacency = normalize_digraph(edge)
        self.A = np.zeros((1,self.num_node,self.num_node))
        self.A[0] = normalize_adjacency 
